...
class ServeClientFasterWhisper(ServeClientBase):
    ...
    def transcribe_audio(self, input_sample, init_prompt=""):
        """
    ...
    def handle_transcription_output(self, result, duration):
        ...
        segments = []
        if len(result):
            transcribed_words = self.ts_words(result)
            self.transcript_buffer.insert(transcribed_words, self.buffer_time_offset)
    ...
    def speech_to_text(self):
        ...
        while True:
            ...
            try:
                ...
                result = self.transcribe_audio(input_sample, init_prompt=prompt)
